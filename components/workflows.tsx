        ...
        <div className="pb-12 md:pb-20">
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-inter text-3xl font-semibold text-transparent md:text-4xl">
              KariyerMatch ile süreci sadeleştir
            </h2>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  Uygun adayları ve ilanları otomatik olarak eşleştirerek, zamandan tasarruf etmenizi ve doğru işi bulmanızı sağlıyoruz.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Küçük işletmeler ve girişimler, aradığı adayı saniyeler içinde bulabilir. Aday havuzuna ulaşım tek tık uzağınızda.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                ...
                <div className="p-6">
                  ...
                  <p className="text-indigo-200/65">
                    Profilini oluştur, CV’ni sistem otomatik olarak hazırlasın. Her başvuru için aynı bilgileri tekrar girme derdi sona eriyor.
                  </p>
                </div>
              </div>
            </a>
