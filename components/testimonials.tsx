...
const testimonials = [
  {
    ...
    name: "Zeynep A.",
    company: "Luna Yazılım",
    content:
      "KariyerMatch ile sadece profilimi doldurdum ve birkaç gün içinde bana uygun bir pozisyon için mülakat teklifi aldım. Otomatik olarak süreç başladı, inanılmaz pratikti.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "NovaTech",
    content:
      "Yeni kurulan bir girişim olarak büyük platformlara ücret ödemek zordu. KariyerMatch ile sadece ihtiyacımı belirttim, 2 gün içinde üç aday önerildi. Harika sistem!",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Alpha Works",
    content:
      "Mülakat süreci başlamadan önce firma beni değerlendirdi ve sistem üzerinden eşleşme geldi. Hazır profilim sayesinde süreç çok hızlı gelişti.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Freelance",
    content:
      "Freelancer olarak farklı alanlarda deneyimim vardı. KariyerMatch profili bu deneyimleri algılayıp bana uygun eşleşmeler sundu. Sistem çok akıllıca.",
    categories: [1, 4],
  },
  {
    ...
    company: "Neo Girişim",
    content:
      "Aday havuzunda kaybolmak yerine doğrudan eşleşme alıyorum. Firmalar teklif gönderdiğinde süreç çok daha özgüvenli ilerliyor.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Idea Lab",
    content:
      "İlan açtıktan sonra onlarca başvuruyla uğraşmak zorunda kalmıyoruz. KariyerMatch bizim için uygun kişiyi öneriyor, sadece kabul etmemiz yeterli.",
    categories: [1, 3],
  },
  {
    ...
    company: "CodeFusion",
    content:
      "Başvuru formu yok, gereksiz detay yok. Profilim hazırlandıktan sonra sistem eşleştirme yaptı. Bu kadar sade ve etkili olmasına şaşırdım.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "VeriAtölye",
    content:
      "Mülakat öncesinde firma profili üzerinden beni tanıyor. Hazırlık süreci çok daha net ve hedefli geçiyor. İş arayanlar için büyük rahatlık.",
    categories: [1, 4],
  },
  {
    ...
    company: "MedyaVizyon",
    content:
      "Tek bir profil oluşturdum ve başvuru yapmadan sürecin başlaması bana çok zaman kazandırdı. Bu sistem klasik kariyer platformlarından çok farklı.",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Bugüne kadar sistemimizi kullanan kullanıcılarımızdan gelen geri dönüşler. KariyerMatch ile sürecin nasıl geliştiğini öğrenin.
          </p>
        </div>
